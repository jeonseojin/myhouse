...
public class ClaimVo {
	...
	private String cl_answer;//답변여부
	
	
	public String getCl_answer() {
		return cl_answer;
	}
	public void setCl_answer(String cl_answer) {
	...
	public String toString() {
		return "ClaimVo [cl_nun=" + cl_nun + ", cl_title=" + cl_title + ", cl_member=" + cl_member + ", cl_auth="
				+ cl_auth + ", cl_file=" + cl_file + ", cl_date=" + cl_date + ", cl_type=" + cl_type + ", cl_answer="
				+ cl_answer + "]";
	}
